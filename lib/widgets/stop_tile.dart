...
class StopTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Color background = switch (stop.areaType) {
      model.AreaType.urban => Colors.cyan[400]!,
      _ => Colors.green[300]!,
    };
              ...
              Container(
                ...
                child: Icon(
                  switch (stop.areaType) {
                    model.AreaType.urban => MingCuteIcons.mgc_building_1_line,
                    model.AreaType.extraurban => MingCuteIcons.mgc_tree_line,
                    model.AreaType.unknown => MingCuteIcons.mgc_desk_line,
                  },
                  size: 28,
                ),
              ),
...
void _goToStopPage(BuildContext context, model.Stop stop) {
